...
{{--            <a class="mr-2 btn btn-danger btn-sm d-flex" href="{{route('sales')}}"><i class="material-icons iconMod">attach_money</i>Ofertas</a>--}}
            <a class="mr-2 btn-sm d-flex" href="{{route('sales')}}"><img style="width: 70px;position: absolute;margin-left: -60px;margin-top: -30px" src="{{asset('assets/images/otros/promocion.png')}}" title="Ofertas Jardepot" alt="Ofertas Jardepot"></a>
