        ...
        <div class="container-xl">
            ...
            <div class="collapse navbar-collapse row" id="navbarsDesktopL">
                <div class="col-md-12 d-flex justify-content-between align-items-center">
                    ...
                    <a class="mr-2 btn-sm d-flex" href="{{route('sales')}}"><img style="width: 100px;position: absolute;margin-left: -100px;margin-top: -60px" src="{{asset('assets/images/ofertas/promocion.png')}}" title="Ofertas Jardepot" alt="Ofertas Jardepot"></a>
