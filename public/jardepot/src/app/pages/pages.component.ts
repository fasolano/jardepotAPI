import {Component, OnInit, HostListener, ViewChild, AfterViewInit, ViewEncapsulation, Output, EventEmitter} from '@angular/core';
...
export class PagesComponent implements OnInit, AfterViewInit  {
  // tslint:disable-next-line:no-inferrable-types
    ...
    public getAdditional() {
        ...
        /*let that = this;
        this.additional.forEach(function(value, key) {
            that.additional[key].options = that.appService.getOptionsAdditional(value.name);
        });*/
    }
